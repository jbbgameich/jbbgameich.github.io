...
var NinePatchImage = (function (_Phaser$Image) {
  ...
  */
	...
	function NinePatchImage(game, key, x, y, width, height, ninePatchImages) {
		if (x === undefined) x = 0;
		if (y === undefined) y = 0;
		...
		if (width === undefined) width = ninePatchImages.width;
		if (height === undefined) height = ninePatchImages.height;
